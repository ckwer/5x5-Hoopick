...
/**
 * Created by pro on 2016-11-19.
 */
public class HpBluetoothSerialService {
    // Debugging
    ...
    private static final UUID SerialPortServiceClass_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B54FB");
    ...
    /*
    public HpBluetoothSerialService(Context context, Handler handler, EmulatorView emulatorView) {
    ...
    */
    ...
    public HpBluetoothSerialService(Handler handler) {
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mState = STATE_NONE;
        mHandler = handler;
        // mContext = context;
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(TOAST, "unable_to_connect" );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                //HpBluetoothSerialService.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (HpBluetoothSerialService.this) {
                mConnectThread = null;
            }
