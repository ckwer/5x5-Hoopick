...
public class ActivityTest extends AppCompatActivity implements HpGameEventListener,HpBluetoothListener{
        ...
        mAlertDialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface alertDialog, int arg1) {
                        ...
                        Intent lIntent = new Intent(ActivityTest.this, ActivityLineup.class);
                        lIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        ActivityTest.this.startActivityForResult(lIntent, REQUEST_CODE_START_ACTIVITY);
    ...
    public void addShotPos(int aPosX, int aPosY) {
        ...
        LayoutInflater inflater = (LayoutInflater) ActivityTest.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    private OnTouchListener  mOnTouchCourt = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                mImageEvent.setX(event.getX() + 70);
